/*!
 * VisualEditor UserInterface MediaWiki MWChartInsertDialog class.
 * hacked
...
ve.ui.MWChartInsertDialog.static.toolbarGroups = [
	// History
	{ 'include': [ 'undo', 'redo' ] },
	// No formatting
	/* {
...
ve.ui.MWChartInsertDialog.static.surfaceCommands = [
	'undo',
	'redo',
	'bold',
	'italic',
...
ve.ui.MWChartInsertDialog.static.pasteRules = ve.extendObject(
 ...
 */
ve.ui.MWChartInsertDialog.prototype.onDocumentTransact = function () {
 ...
 */
ve.ui.MWChartInsertDialog.prototype.onSearchSelect = function ( ref ) {
 ...
 */
ve.ui.MWChartInsertDialog.prototype.getReferenceNode = function () {
 ...
 * @chainable
 */
ve.ui.MWChartInsertDialog.prototype.useReference = function ( ref ) {
	// Properties
	if ( ref instanceof ve.dm.MWReferenceModel ) {
